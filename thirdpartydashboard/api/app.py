...
#from thirdpartydashboard.api.auth.token_storage import impls as storage_impls
#from thirdpartydashboard.api.auth.token_storage import storage
from thirdpartydashboard.api import config as api_config
#from thirdpartydashboard.api.middleware.cors_middleware import CORSMiddleware
#from thirdpartydashboard.api.middleware import token_middleware
#from thirdpartydashboard.api.middleware import user_id_hook
from thirdpartydashboard.api.v1.search import impls as search_engine_impls
from thirdpartydashboard.api.v1.search import search_engine
#from thirdpartydashboard.notifications.notification_hook import NotificationHook
from thirdpartydashboard.openstack.common.gettextutils import _  # noqa
from thirdpartydashboard.openstack.common import log
#from thirdpartydashboard.plugin.user_preferences import initialize_user_preferences
...
def setup_app(pecan_config=None):
    ...
    cfg.set_defaults(log.log_opts,
                     default_log_levels=[
                         'thirdpartydashboard=INFO',
                         'thirdpartydashboard.openstack.common.db=WARN',
                         'sqlalchemy=WARN'
                     ])
    log.setup('thirdpartydashboard')
...
def start():
    CONF(project='thirdpartydashboard')
